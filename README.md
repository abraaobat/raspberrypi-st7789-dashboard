...
Na v0.9.0 (`8108307`), 162 testes passaram no computador (18,821 s) e no ARM em checkout separado (67,427 s); três opcionais Mosquitto foram ignorados nesses hosts. No [CI](https://github.com/abraaobat/raspberrypi-st7789-dashboard/actions/runs/35258059111), todos os 165 passaram (19,051 s), assim como o fluxo completo do painel com os três serviços fictícios. A landing local/publicada passou nas oito combinações; fotos/Pix foram preservados. Novo backup privado e auditoria posterior confirmaram PIN/configuração/chave de sessão/cofre e serviços v0.6.0 inalterados. Novos modelos renderizam nos três perfis em software; apps reais/TFT ficam no checklist final. [Evidências e preparo](docs/NEXT_SESSION.md), sem confundir testes com implantação.
